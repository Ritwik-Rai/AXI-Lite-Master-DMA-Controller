...
HD_PWD='C:/Users/maste/OneDrive/Documents/I-CHIP/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_dma_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_dma_controller.tcl
